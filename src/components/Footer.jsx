      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          ...
          <p className="text-gray-600 text-xs">
            Développé par{' '}
            <a href="https://www.linkedin.com/in/ayoub-faradi/" target="_blank" rel="noopener noreferrer" className="text-gold-400 hover:text-gold-300 transition-colors">Ayoub Faradi</a>
          </p>
        </div>
      </div>
    </footer>
